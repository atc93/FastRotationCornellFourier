...
for i in range (1, 25):
    filename = 'txt/endGame_calo'+ str(i) + '_statFluc.txt'
...
plt.errorbar(caloNum, xe, yerr=statXeStd, fmt='o', zorder=1)
#plt.plot(caloNum, xe, 'rx', label='central value', zorder=2)
...
plt.errorbar(caloNum, width, yerr=statWStd, fmt='o', zorder=1)
#plt.plot(caloNum, width, 'rx', label='central value', zorder=2)
plt.legend(loc=9, bbox_to_anchor=(.1, 1.01, 0.75, .07), ncol=2, mode="", prop={'size':7})
plt.xlabel('Calo #')
...
plt.errorbar(caloNum, ce, yerr=statCeStd, fmt='o', zorder=1)
#plt.plot(caloNum, ce, 'rx', label='central value', zorder=2)
plt.legend(loc=9, bbox_to_anchor=(.1, 1.01, 0.75, .07), ncol=2, mode="", prop={'size':7})
plt.xlabel('Calo #')
