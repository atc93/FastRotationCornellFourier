...
inputRootFile="root/FRS_60h_bunch$1.root"
outputRootFile="root/60h_t0Opt_bunch$1.root"
outputTextFile="txt/60h_t0Opt_bunch$1.txt"
histoName="fr"
...
outputRootFile="root/60h_fourierAnalysis_bunch$1.root"
outputTextFile="txt/60h_fourierAnalysis_bunch$1.txt"
fieldIndex=0.108
printPlot=1
